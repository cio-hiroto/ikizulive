...
# 出力ファイルパス
JSON_FILE = os.path.join(OUTPUT_DIR, 'akira_tweets.json')
BATCH_SIZE = 100
SLEEP_SECONDS = 2
...
async def main():
    ...
    # time-only field removed per request; created_at includes full datetime
        ...
        if t.id in tweet_dict:
            ...
            tweet_dict[t.id] = {
                ...
                # created_at contains full datetime (YYYY/MM/DD HH:MM:SS)
